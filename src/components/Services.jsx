    ...
    return (
        <div className='flex flex-col  bg-white gap-8 py-20'>
            ...
            <div className='flex flex-col items-center justify-center gap-8 '>
                <img src={leaf} />
                <p className='text-2xl font-semibold text-[#6b6b6b]'>WE TELL STORIES</p>
                <p className='text-3xl font-bold text-[#6b6b6b]'>We are here to connect and document your love story the way you want it told</p>
            </div>
